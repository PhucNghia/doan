        ...
        function ($timeout,$scope,$rootScope,$translate,$state, JhiLanguageService, tmhDynamicLocale,$window) {
            ...
            var menu = {
                'inventory': [
                    ...
                    {
                        id: 16,
                        title: 'admin.menu.comment',
                        icon: 'message',
                        link: 'comments',
                        privilege:"ROLE_SYSTEM_ADMIN,ROLE_SYSTEM_USER,ROLE_HOME_ADMIN, Comment_View"
                    },
                    {

                        id: 18,
                        title: 'admin.menu.notificationManager',
                        icon: 'notifications',
                    ...
                    },
                    {
                        ...
                        icon: 'filter_none',
                        link: 'screenplays',
                        privilege:"ROLE_SYSTEM_ADMIN,ROLE_SYSTEM_USER,ROLE_HOME_ADMIN, Screenplay_View"
                    },
                    {
                        id: 3,
...
//                            }
                    ...
                    // },
                    {
                        ...
                        icon: 'people',
                        privilege: "ROLE_SYSTEM_ADMIN, ROLE_SYSTEM_USER, ROLE_HOME_ADMIN, Device_Report_View, Customer_Report_View, Periodically_Report_View",
                        submenu: [
                            {
                                id: 13,
                            ...
                            {
                                id: 15,
                                title: 'admin.menu.reportPeriodically',
                                link: 'report-periodically',
                                privilege: "ROLE_SYSTEM_ADMIN,ROLE_SYSTEM_USER,ROLE_HOME_ADMIN, Periodically_Report_View"
                            }
                        ]
                    },

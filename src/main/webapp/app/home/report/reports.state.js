(function () {
    ...
    function stateConfig($stateProvider) {
        ...
        $stateProvider
            ...
            .state('report-periodically',{
                parent: 'report-module',
                url: '/report-periodically',
                templateUrl: 'app/home/report/report-periodically.html',
                controller: 'ReportPeriodicallyController',
                controllerAs: 'vm',
                params: {
                    packageId: null
                },
                data: {
                    pageTitle: 'Báo cáo số lượng định kỳ',
                    authorities: ['ROLE_SYSTEM_ADMIN','ROLE_SYSTEM_USER','ROLE_HOME_ADMIN', 'Periodically_Report_View'], //TODO change role,
                    sideBarMenu: 'inventory'
                },
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            ...
                            'lazy_KendoUI',
                            'lazy_parsleyjs',
                            'app/home/report/report-Periodically.controller.js'
                        ]);
                    }]
                }
            })
